...
public class HttpSendUtil {
    ...
    public static JsonObject downloadAttach(Long msgId) {
        return HttpSyncUtil.exec(HttpAsyncUtil.Type.DOWNLOADATTACH, JsonObject.mapFrom(new SendMsg().setMsgId(msgId)));
    }
    ...
    public static JsonObject 发送图片(String wxid, String msg) {
        return HttpSyncUtil.exec(HttpAsyncUtil.Type.发送图片, JsonObject.mapFrom(new SendImg().setImagePath(msg).setWxid(wxid)));
    }
    ...
    public static ContactList 联系人列表(String wxid){
        JsonObject exec = HttpSyncUtil.exec(HttpAsyncUtil.Type.联系人列表, JsonObject.mapFrom(new SendMsg().setWxid(wxid)));
     ...
     * @return
     */
    public static JsonObject GetContactByWxid(String wxid){
        JsonObject exec = HttpSyncUtil.exec(HttpAsyncUtil.Type.GETCONTACTBYWXID, JsonObject.mapFrom(new SendMsg().setWxid(wxid)));
        return exec.getJsonObject("data");
    }
